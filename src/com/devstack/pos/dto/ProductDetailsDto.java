...
public class ProductDetailsDto implements SuperEntity {
    private String code;
    ...
    public ProductDetailsDto(String code, String barcode, int qtyOnHand, double sellingPrice, double buyingPrice, double showPrice, int productCode, boolean discountAvailability) {
        this.code = code;
